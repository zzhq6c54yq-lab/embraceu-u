...
const insightsData: Record<string, Array<{ text: string }>> = {
  PRESENCE: [
    ...
    { text: "The present moment is the only moment where life is available. Everything else is memory or imagination." },
    { text: "Presence is not about emptying your mind, but filling it with what's actually happening now." },
    { text: "When you notice you're not present, that noticing IS presence. You've already returned." },
    { text: "Treat every interaction as if it might be the last. This urgency creates profound presence." },
    { text: "Your body is always in the present. When lost in thought, return to physical sensation." },
  ],
  ACTION: [
    ...
    { text: "Motion beats meditation when you're stuck. Move your body to move your mind." },
    { text: "The gap between where you are and where you want to be is bridged by consistent action." },
    { text: "Perfectionism is procrastination in disguise. Done is better than perfect." },
    { text: "Stack new habits onto existing ones. Habit stacking creates automatic behaviors." },
  ...
  FOCUS: [
    ...
    { text: "Deep work is a skill that must be trained. Start with short sessions and build up." },
    { text: "Your phone is not a productivity tool. It's a distraction device in your pocket." },
    { text: "Focus is saying no to the hundred other good ideas. Choose your priorities." },
    { text: "The quality of your attention determines the quality of your life." },
    { text: "Attention is like a muscle. The more you train it, the stronger it becomes." },
  ],
  "SELF-KINDNESS": [
    ...
    { text: "Forgive yourself for past mistakes. You were doing the best you could with what you knew." },
    { text: "Your inner critic is not trying to help. Thank it for its concern, then let it go." },
    { text: "Rest is not a reward for productivity. It's a requirement for human functioning." },
  ...
  RESILIENCE: [
    ...
    { text: "Post-traumatic growth is real. Adversity can forge profound strength and wisdom." },
    { text: "The obstacle is the way. What stands in your path becomes your path." },
    { text: "You've survived 100% of your worst days so far. That's a perfect track record." },
    { text: "Struggle is not a sign something is wrong. It's a sign you're being stretched." },
  ...
  GRATITUDE: [
    ...
    { text: "When life gives you a hundred reasons to cry, show life you have a thousand to smile." },
    { text: "The more you praise and celebrate life, the more there is in life to celebrate." },
    { text: "Gratitude makes sense of our past, brings peace for today, and creates vision for tomorrow." },
    { text: "Not what we have but what we enjoy constitutes our abundance." },
    { text: "Grateful people are 25% happier and sleep better. Gratitude is a health practice." },
  ],
  MINDFULNESS: [
    ...
    { text: "Thoughts are like clouds passing through the sky of your mind. Watch them float by." },
    { text: "You are not your thoughts. You are the awareness observing them." },
    { text: "When washing dishes, just wash dishes. When walking, just walk. That is mindfulness." },
    { text: "Mindfulness is a way of being, not a technique. It's remembering to be awake." },
    { text: "The breath is always available as a doorway back to presence." },
  ],
  GROWTH: [
    ...
    { text: "Your potential is not fixed. It expands with effort, strategy, and help from others." },
    { text: "Discomfort is the currency of your dreams. Pay it willingly." },
    { text: "Who you become in the pursuit is more important than what you achieve." },
  ],
};
